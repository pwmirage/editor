...
<div class="content flex-rows">
	<div id="filters" class="flex-rows" style="gap: 0;">
		...
		<label style="margin-top: 4px;"><input type="checkbox" class="checkbox" id="show-removed-spawners"><span>Show removed spawners</span></label>
	</div>

	<div id="options" class="flex-rows">
		<div style="flex: 1;"></div>
		<label><input type="checkbox" class="checkbox" id="show-real-bg"><span>Show real ingame terrain</span></label>
