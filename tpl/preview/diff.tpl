...
<div style="font-size: 13px;">
	...
	{assign prev = $obj._db.project_initial_state}
	{for fname in $diff}
			...
			<div class="block">
				...
				{for rowid of $rows}
					<div class="block">
						...
						{for i = 0; i < 8; i++}
							{assign prev_id = $prev_page.item_id[$rowid * 8 + $i]}
							{assign cur_id = $page.item_id[$rowid * 8 + $i] ?? $prev_id}
							<div class="flex-rows" style="gap: 2px;" onmousemove="PWPreview.try_show_obj_tooltip({serialize $db}, event);" onmouseleave="this.onmousemove(event);">
			...
			<div class="block">
				...
				{for rowid of $rows}
					<div class="block">
						...
						{for i = 0; i < 8; i++}
							{assign prev_id = $prev_page.recipe_id[$rowid * 8 + $i]}
